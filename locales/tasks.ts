export const tasksLocales = {
  sk: {
    ...
    mode_inventory: "INVENTÚRA",
    inv_part_label_optional: "Diel / Číslo dielu (nepovinné pre celú lokáciu)",
    inv_loc_label_compulsory: "Skladová lokácia / Regál (povinné)",
  ...
  en: {
    ...
    inv_part_label_optional: "Part / Part Number (optional for entire location)",
    inv_loc_label_compulsory: "Warehouse Location / Shelf (required)",
